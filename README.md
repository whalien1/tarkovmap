...
**打开即地图。不联网、不碰游戏进程；误点关闭按钮时最小化到系统托盘，只做地图。**
...
- 左侧底部“产品信息”区：显示主程序版本、当前 MapData 版本与产品说明；“帮助 → 关于”显示相同信息
- **防误关托盘**：点击主窗口关闭按钮或按 Alt+F4 时隐藏到系统托盘，截图监听继续运行；双击托盘图标恢复窗口；通过“文件 → 退出”或托盘菜单“退出”才真正关闭程序
